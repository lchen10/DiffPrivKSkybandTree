...
public class ExpMecTopKDom {
	...
	public static List<Tuple> ExpMecTopKDom(List<Tuple> group, List<Comparison> comparisons, int k) throws Exception {
		...
		// calculate the distance between each dominated point with the cluster
		// center
