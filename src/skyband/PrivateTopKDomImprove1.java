...
public class PrivateTopKDomImprove1 {
...
//			double radius_t = distTuple.get(idx).getDist();
//			double radius_t_1 = distTuple.get(idx-1).getDist();
//			
//			
//			Random generator = new Random();		
//		//	Random r = new Random();
//			double randomRadius = radius_t_1 + (radius_t - radius_t_1) * generator.nextDouble();
//			
//	//		System.out.println("random is: " + randomRadius);
//			
//			double x = maxTuple.getValue(0);
//			double y = maxTuple.getValue(1);
//			debug("=========PRIVATE found: " + distTuple.get(idx) + ", " + radius_t);
//			debug("=========Previous one of PRIVATE found: " + distTuple.get(idx-1) + ", " + radius_t_1);
//			debug("radius is: " + randomRadius);
//			debug("x is: " + x);
//			debug("y is: " + y);
//
//	//		Random generator = new Random();
...
//			debug("Angle is: " + angle);
//		
//			debug("sin(" + angle + ") is " + Math.sin(angle));
//			debug("cos(" + angle + ") is " + Math.cos(angle));
//
//			double randx = x + randomRadius * Math.cos(angle);
//			double randy = y + randomRadius * Math.sin(angle);
//
//			debug("======randomRadius_X is: " + randx);
//			debug("======randomRadius_Y is: " + randy);
//		
//
