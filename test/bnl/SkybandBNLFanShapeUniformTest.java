...
public class SkybandBNLFanShapeUniformTest {
	...
	public void testKSkylineBandOn15Clusters() throws Exception {
		...
		for (String filename : files) {
			...
			for (int k : ks) {
				System.out.println("compute " + k + "-skylineband for "
						+ filename);
