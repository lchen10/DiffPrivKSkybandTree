...
public class TrueOptimalkFMeasureTest {
	@Test
	public void testFMeasure() throws Exception {
		PrintWriter out = new PrintWriter("fmeasure/true-optimalK.csv");
		int ite = 1;
		int level = 4;
		out.println("k,true coutn, private count,tp,fp,fn,precision,recall,fmeasure,totalerror,avgerror");
		for (int k = 100; k <= 100; k += 50) {
			...
			for (int o = 0; o < ite; o++) {
				...
				String privatefile = "bbs_output/" + "optimalKgrid-ns-bbs-skyband-k-" + k + "-level-" + level + "." + o
						+ ".csv"+"-k-"+100+".csv";
			...
			out.println(k + "," + t_truesize / ite + "," + t_privsize / ite + "," + t_tp / ite + "," + t_fp / ite + ","
