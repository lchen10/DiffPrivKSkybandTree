...
public class DiffPrivOptimalKSpaceMinSizePartitionTest {
	@Test
	public void testLoadPoints() throws Exception {
		...
		double[] splitrates = new double[] { 0.01};
...
//							root = p.postProcessing(root, epslevel, level);
							...
							PrintWriter grid = new PrintWriter("kspaceoutput/dfoptimalKgrid-ms-k-" + k + "-level-"
