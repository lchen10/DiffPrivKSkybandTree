...
public class MultiDim100kFMeasureChartTest {
	...
	public void testChart() throws Exception {
		...
		for (double eps : epslist) {
			List<String> lines = Files.readAllLines(Paths
					.get("evaluations/multidim100k/anti/results-eps-" + eps + ".csv"));
...
//					rangeAxis.setUpperMargin(0.5);
					...
					saveChartAsPDF(new File("evaluations/fmeasure/multidim100k/" + filename
