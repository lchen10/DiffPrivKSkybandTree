...
public class FanShapeRandomUniformGeneratorTest {
	@Test
	public void testGenerateFanShapeRandomData() throws Exception {
		FanShapeRandomGenerator f = new FanShapeRandomGenerator();
		List<Tuple> tuples = f.generateFanUniformRandomTuple(10000, 0, 5000, 0, 5000);
		PrintWriter csv = new PrintWriter("dataset/fan-uniform.csv");
		PrintWriter dat = new PrintWriter("dataset/fan-uniform.dat");

		final XYSeriesCollection dataset = new XYSeriesCollection();
		File fig = new File("evaluations/fanshape-uniform.png");
		...
		JFreeChart chart = ChartFactory.createScatterPlot("Fan shaped uniform random", "x", "y", dataset,
